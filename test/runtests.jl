...
@test locf(a) == a
@test locf(b) == [Nullable{Float64}(1.0), Nullable{Float64}(1.0), Nullable{Float64}(3.0)]
@test locf(c) == [Nullable{Float64}(1.0), Nullable{Float64}(2.0), Nullable{Float64}(2.0)]
@test locf(d) == [Nullable{Float64}(2.0), Nullable{Float64}(2.0), Nullable{Float64}(3.0)]
@test locf(d, true) == [Nullable{Float64}(2.0), Nullable{Float64}(2.0), Nullable{Float64}(3.0)]
